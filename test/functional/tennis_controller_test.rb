...
class TennisControllerTest < ActionController::TestCase
  ...
  test "should create tenni" do
    assert_difference('Tenni.count') do
      post :create, tenni: { classementactuel: @tenni.classementactuel, datemeilleurclassement: @tenni.datemeilleurclassement, email: @tenni.email, meilleurclassement: @tenni.meilleurclassement }
    end
  ...
  test "should update tenni" do
    put :update, id: @tenni, tenni: { classementactuel: @tenni.classementactuel, datemeilleurclassement: @tenni.datemeilleurclassement, email: @tenni.email, meilleurclassement: @tenni.meilleurclassement }
    assert_redirected_to tenni_path(assigns(:tenni))
  end
